...
LONG CDlgDemoDlg::OnComm(WPARAM ch, LPARAM port)
{
	...
	m_strReceive.Format("%X %X %x %x %x %x %x %x %x %x %x %x %d",QUEUESIZE,tempData[0],tempData[1],tempData[2],tempData[3],tempData[4],tempData[5],tempData[6],tempData[7],tempData[8],tempData[9],check,recNumber);
#endif
