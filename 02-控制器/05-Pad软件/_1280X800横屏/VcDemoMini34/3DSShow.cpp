...
{//////////////////////////////////////////////////////////////////
	...
	glClearColor(0.0f,0.0f,0.0f,0);//设置刷新背景色
...
//{		//				 序号   ,位置x  ,高度   ,位置y  ,半径   ,角度  ,大小
			...
			Scene(0,0,0,-1.15,0,0,0.5f);//显示对象
			Scene(1,0,0,-1.15,0,r,0.5f);//显示对象
...
void C3DSShow::InitCWnd()
{
	...
	r=0;
	Width=150;//GetSystemMetrics(SM_CXSCREEN);
				Height=150;//GetSystemMetrics(SM_CYSCREEN);
				MoveWindow(5,621,Width,Height);//窗口定位
				////////////////////////////////////////////////////////////
				glViewport(0, 0,Width,Height);// reset the viewport to new dimensions
				glMatrixMode(GL_PROJECTION);	// set projection matrix current matrix
				gluPerspective(45.0f,(GLfloat)Width/(GLfloat)(Height-0),1.0f,2000.0f);
