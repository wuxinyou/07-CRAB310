...
////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// 设置电量图标部件位置和尺寸
	this->m_padVol.MoveWindow(90,14,76,22);
	this->m_ctrlBoxVol.MoveWindow(286,14,76,22);
	this->m_leftVol.MoveWindow(488,14,76,22);
	this->m_rightVol.MoveWindow(684,14,76,22);
	// 设置速度，工作模式，红外，通道 显示位置和尺寸
	this->m_speed.MoveWindow(830,12,25,25);
	this->m_workMode.MoveWindow(966,12,60,25);
...
void CDlgDemoDlg::ShowOSD()
{
	...
	case 1:
		//设置文本1和文本2的显示坐标
		TosdInfo[dwCard].TxtPlaceX[0]=336;
		TosdInfo[dwCard].TxtPlaceY[0]=455;
		...
		//观测画面
	case 2:
		TosdInfo[dwCard].TxtPlaceX[1]=336;
...
//////////////////////////////////////显示开机界面//////////////////////////////////////////
void CDlgDemoDlg::ShowWelcomeUI()
{
	SHELLEXECUTEINFO   ShExecInfo_1   =   {0};
    ShExecInfo_1.cbSize   =   sizeof(SHELLEXECUTEINFO);
    ShExecInfo_1.fMask   =   SEE_MASK_NOCLOSEPROCESS;
    ShExecInfo_1.hwnd   =   NULL;
    ShExecInfo_1.lpVerb   =   NULL;
    ShExecInfo_1.lpFile   =   "WelcomUI.exe";
    ShExecInfo_1.lpParameters   =   " ";
    ShExecInfo_1.lpDirectory   =   NULL;
    ShExecInfo_1.nShow   =   SW_MINIMIZE;
    ShExecInfo_1.hInstApp   =   NULL;
    ShellExecuteEx(&ShExecInfo_1);
...
//	::ShowWindow(hWnd, SW_HIDE);
	...
	//	SetTimer(6,500,NULL);
    Sleep(4000); //延时3秒后关闭刚才打开的程序
    TerminateProcess(ShExecInfo_1.hProcess,INFINITE);
}
