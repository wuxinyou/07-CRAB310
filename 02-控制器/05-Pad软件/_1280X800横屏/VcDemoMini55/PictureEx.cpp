...
/*	  CString debug;
	  debug.Format("m_PictureSize.cx= %d,hmWidth= %d,hmHeight= %d",m_PictureSize.cx,hmWidth,hmHeight);
	  AfxMessageBox( debug);


	  m_PictureSize.cx=1200;
	  m_PictureSize.cy=800;
	  hmWidth=20000;// add by wu
	  hmHeight=12000;// add by wu*/
...
//AfxMessageBox("ExOnPaint");
//modified bu wu 20161020
 // SIZE size = GetSize();
