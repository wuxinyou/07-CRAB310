...
UINT CSerialPort::CommThread(LPVOID pParam)
{
	...
	//	try
		...
		Event = WaitForMultipleObjects(3, port->m_hEventArray, FALSE, 500);
...
//			port->ProcessErrorMessage("GetOverlappedResults() in WriteFile()");
	...
	{
		//	throw BytesSent;   //如果在这里抛出异常会导致数据接收不到多少就停止了工作了，原因不详
	//0809	TRACE("WARNING: WriteFile() error.. Bytes Sent: %d; Message Length: %d\n", BytesSent, strlen((char*)port->m_szWriteBuffer));
	}
