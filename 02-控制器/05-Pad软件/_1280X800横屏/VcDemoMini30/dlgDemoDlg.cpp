...
////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// 设置电量图标部件位置和尺寸
	this->m_padVol.MoveWindow(200,760,96,20);
	this->m_ctrlBoxVol.MoveWindow(415,760,96,20);
	this->m_leftVol.MoveWindow(608,760,96,20);
	this->m_rightVol.MoveWindow(795,760,96,20);
...
//初始化预览区窗口	
	...
	//初始化充电动态图 和 加载资源动态图
	m_chargeGIF.MoveWindow(165+116,76,718,568);
	m_loadDevicesGIF.MoveWindow(165+116,76,718,568);
...
//	this->MoveWindow(0,0,cx,cy);
	...
	m_snapBtn.MoveWindow(7,32,150,160);
	...
	m_recordBtn.MoveWindow(7,224,150,160);
	...
	m_settingBtn.MoveWindow(7,416,150,160);
	...
	m_txtViewerBtn.MoveWindow(1123,32,150,160);
	...
	m_picViewerBtn.MoveWindow(1123,224,150,160);
	...
	m_videoPlayerBtn.MoveWindow(1123,416,150,160);
	...
	m_exitBtn.MoveWindow(1123,608,150,160);
