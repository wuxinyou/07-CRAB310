...
2.设置总在最前面：软件启动时默认为总在最前面，当关闭进程VLC之后，恢复 不在最前面。

VcDemoMini54
20161102  pm
1.添加控制器0电压指示。
2.去除GIF动态显示功能,取而代之的是蓝屏显示。
3.添加视频回放的 背景填充黑色
4.发布测试。
...
2.修改电量显示的的问题，和控制器一致
20161107 am
3.修改图片双击全屏，避开下一张按钮坐标。

VcDemoMini56
20161108
1.关于电量显示：将显示算法与控制器保持一直，即采用直接判断法。
2.发布测试。。
3.更改界面。。。，添加软件标题
4.去除OSD的画面显示。
5.通过接收数据标志串口连接正常来确定显示控制器电量和蓝牙状态，
	从而完善了之前蓝牙指示异常的情况,同时将速度显示周期改为100ms。已修改。发布测试。

VcDemoMini57
20161109
1.常规完善。。。
2.检查：为什么录制的视频会保存在前一天的目录下面？