...
//
// Write by tony yu qq:2810482962
...
public:
	...
	BOOL StartRecord(HANDLE ChannelHandle,CString szFileName,CString CodecType, VidCodecX264Para H264CodecPara);
