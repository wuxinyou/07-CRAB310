...
void CDlgDemoDlg::UpdatePowerStatus()
{
	...
	m_padPower.SetPos(SystemPowerStatus.BatteryLifePercent);
...
void CDlgDemoDlg::OnClosedevbtn() 
{
	...
	if(bDevIsConnect)
	{
		DXDeviceStop(DeviceInfo[0].dwChannelHandle);  //关闭采集卡
