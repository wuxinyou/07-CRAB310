...
static	void	ADC1_GPIO_Config(void)
{
	...
	STM32_GpioOneInit(GPIO_Pin_1,GPIO_Speed_50MHz,GPIO_Mode_AIN,GPIOA);	//	配置相应通道
	STM32_GpioOneInit(GPIO_Pin_2,GPIO_Speed_50MHz,GPIO_Mode_AIN,GPIOA);	//	配置相应通道
	STM32_GpioOneInit(GPIO_Pin_3,GPIO_Speed_50MHz,GPIO_Mode_AIN,GPIOA);	//	配置相应通道
	STM32_GpioOneInit(GPIO_Pin_4,GPIO_Speed_50MHz,GPIO_Mode_AIN,GPIOA);	//	配置相应通道
	STM32_GpioOneInit(GPIO_Pin_5,GPIO_Speed_50MHz,GPIO_Mode_AIN,GPIOA);	//	配置相应通道
	STM32_GpioOneInit(GPIO_Pin_6,GPIO_Speed_50MHz,GPIO_Mode_AIN,GPIOA);	//	配置相应通道
	STM32_GpioOneInit(GPIO_Pin_7,GPIO_Speed_50MHz,GPIO_Mode_AIN,GPIOA);	//	配置相应通道
	STM32_GpioOneInit(GPIO_Pin_0,GPIO_Speed_50MHz,GPIO_Mode_AIN,GPIOB);	//	配置相应通道
}
