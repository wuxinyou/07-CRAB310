	...
	: CDialog(pd652Dlg::IDD, pParent)
{
	...
	//}}AFX_DATA_INIT
	//	1031 m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}
...
BOOL pd652Dlg::OnInitDialog()
{
	...
	//
	{
		...
		//
		{
			...
			m_oChannelWindows[ 0 ].MoveWindow( 20, 0, cx + 720, cy + 480 );
//
			m_oChannelWindows[ 1 ].MoveWindow( 50, 0, cx + 720, cy + 480 );
...
void pd652Dlg::OnDestroy() 
{
	...
	{	m_oChannelWindows[ 0 ].DestroyWindow();
		...
		//	1031 m_oSetupDialog.DestroyWindow();
	}
...
void pd652Dlg::OnTimer(UINT nIDEvent) 
{
	...
	if( nIDEvent == 0x00000000 )
	{
		...
		if( m_bNoSignal )
		{
			...
			//	1031 m_oSetupDialog.m_staticDeviceFormatInformation.SetWindowText( _T("INFO :...") );
		...
		{
			//	1031 m_oSetupDialog.m_staticDeviceFormatInformation.SetWindowText( (LPCTSTR)m_strFormatChangedOutput );
