...
BOOL CTransparentDemonDlg::OnInitDialog()
{
	...
	//检验位
	m_cmbConfirmRS.AddString("无");
	m_cmbConfirmRS.AddString("奇");
	m_cmbConfirmRS.AddString("偶");
	m_cmbConfirmRS.AddString("标记");
	m_cmbConfirmRS.AddString("空");
